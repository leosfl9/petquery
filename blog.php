...
<body>
    ...
    <div class="container mb-5 mt-5">
        ...
        <h3 class="mb-5" id="blog" style="text-align: left; font-weight: 900; margin-top: 20px">Últimas notícias</h3>
    ...
    <nav class="container-fluid p-5" style="background-color: #F7F7F7;">
        <div class="row">
          <div class="col-sm-3 mb-5" style="text-align: center;">
            ...
            <a href="mapa.php" style="text-decoration: none; color: #000"><span style="font-size: 14px">Nossas lojas</span></a><br>
