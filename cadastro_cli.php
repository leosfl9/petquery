            ...
            <form method="POST" action="">
                ...
                <div class="row">
                    <div class="col-lg-6 mb-4">
                        ...
                        <div class="mb-4">
                            <input type="text" minlength="11" maxlength="11" placeholder="CPF" class="form-control" minlength="11" maxlength="11" id="cpfcadastro" style="border-color: #a9a9a9" required>
                        </div>
                        <div class="mb-4">
                            <div class="row">
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="mb-4">
                            <input type="email" placeholder="E-mail" minlength="1" maxlength="200" class="form-control" id="emailcadastro" style="border-color: #a9a9a9" required>
                        </div>
                        <div class="mb-4">
                            <input type="password" placeholder="Senha" minlength="8" maxlength="50" class="form-control" id="senhacadastro" style="border-color: #a9a9a9" required>
                        </div>
                        <div class="mb-4">
                            <input type="password" placeholder="Confirmar senha" minlength="8" maxlength="50" class="form-control" minlength="11" maxlength="11" id="confcadastro" style="border-color: #a9a9a9" required>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid mb-5">
                        <div class="row justify-content-center text-center mt-3">
                            <button type="submit" class="btn mb-3" style="background-color: #518CD7; color: #fff; font-weight: 600; width: 98%">Crie uma conta</button>
                        </div>
                    </div>
